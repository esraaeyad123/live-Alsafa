                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="facebook" name="snapchat" value="{{ $setting->snapchat }}" class="form-control" placeholder="facebook url">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="reddit">whatsapp</label>
                                                    <input type="reddit" name="whatsapp" value="{{ $setting->whatsapp }}" class="form-control" placeholder="reddit url">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
